...
class ReportController extends Controller
{
    ...
    {
        // Handle export logic here (PDF, Excel, etc.)
    ...
    public function downloadCompaniesReport(Request $request)
    {
        ...
        if ($type === 'pdf') {
            ...
            return $this->downloadExcel($companies, $title, $filename);
        }
    }
    ...
    private function downloadExcel($companies, $title, $filename)
    {
        return Excel::download(new CompaniesExport($companies, $title), $filename . '.xlsx');
    }
}