...
@section('page-subtitle', 'Muhtsari na mauzo ya leo - ' . now()->format('d/m/Y'))
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- Manunuzi Leo -->
        <div class="group relative">
            <div class="absolute inset-0 bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-300"></div>
            <div class="relative bg-gradient-to-br from-green-500 to-green-600 p-6 rounded-2xl shadow-xl text-white transform transition-transform duration-300 group-hover:scale-105">
                <div class="flex justify-between items-start mb-4">
                    <div class="p-3 bg-white/20 rounded-2xl">
                        <i class="fas fa-truck-loading text-xl"></i>
                    </div>
                    <div class="text-white/70 text-sm font-medium">Manunuzi</div>
                </div>
                <div class="font-bold text-3xl mb-2">{{ number_format($manunuziLeo, 0) }} <span class="text-sm">Tsh</span></div>
                <div class="flex items-center text-white/80 text-sm">
                    <i class="fas fa-calendar-day mr-2"></i>
                    <span>Leo</span>
                </div>
    ...
    <div class="bg-emerald-200 hover-emerald rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="text-center p-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200">
                <div class="p-3 bg-white rounded-xl shadow-sm inline-flex mb-3">
                    <i class="fas fa-boxes text-blue-600 text-xl"></i>
                </div>
                <div class="text-2xl font-bold text-gray-800">{{ number_format($jumlaBidhaa) }}</div>
                <div class="text-sm text-gray-600 mt-1">Jumla ya Bidhaa</div>
            </div>
            ...
            <div class="text-center p-4 rounded-xl bg-gradient-to-br from-green-50 to-green-100 border border-green-200">
                ...
                <div class="text-2xl font-bold text-gray-800">{{ number_format($jumlaIdadi) }}</div>
                <div class="text-sm text-gray-600 mt-1">Jumla ya Idadi</div>
            </div>
            ...
            <div class="text-center p-4 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200">
                ...
                <div class="text-2xl font-bold text-gray-800">{{ number_format($thamani, 0) }}</div>
                <div class="text-sm text-gray-600 mt-1">Thamani ya Bidhaa</div>
            </div>
        </div>
    </div>

    <!-- Right Side: Top Products -->
    <div class="bg-purple-200 rounded-2xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-center justify-between mb-6">
            <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-emerald-200 rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="text-center p-4 rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 transform transition-transform duration-300 hover:scale-105">
                <div class="inline-flex p-3 rounded-xl bg-green-100 text-green-600 mb-3">
                    <i class="fas fa-check-circle"></i>
                </div>
                <div class="text-2xl font-bold text-gray-800">{{ number_format($bidhaaZilizopo) }}</div>
                <div class="text-sm text-gray-600 mt-1">Zilizopo</div>
            </div>
            
            <div class="text-center p-4 rounded-xl bg-gradient-to-br from-red-50 to-rose-50 border border-red-200 transform transition-transform duration-300 hover:scale-105">
                <div class="inline-flex p-3 rounded-xl bg-red-100 text-red-600 mb-3">
                    <i class="fas fa-times-circle"></i>
                </div>
                <div class="text-2xl font-bold text-gray-800">{{ number_format($bidhaaZimeisha) }}</div>
                <div class="text-sm text-gray-600 mt-1">Zimeisha</div>
            </div>
            
            <div class="text-center p-4 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 transform transition-transform duration-300 hover:scale-105">
                <div class="inline-flex p-3 rounded-xl bg-amber-100 text-amber-600 mb-3">
                    <i class="fas fa-exclamation-triangle"></i>
                </div>
                <div class="text-2xl font-bold text-gray-800">{{ number_format($bidhaaKaribiaKuisha) }}</div>
                <div class="text-sm text-gray-600 mt-1">Karibia Kuisha</div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-purple-200 rounded-2xl shadow-sm border border-gray-100 p-6">
        <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2 mb-6">
            <div class="w-2 h-5 bg-gradient-to-b from-rose-500 to-pink-500 rounded-full"></div>
            Muhtasari wa Madeni
        </h3>
        
        <div class="grid grid-cols-2 gap-4">
            <div class="text-center p-5 rounded-xl bg-gradient-to-br from-red-50 to-rose-50 border border-red-200">
                <div class="inline-flex p-3 rounded-xl bg-red-100 text-red-600 mb-3">
                    <i class="fas fa-money-bill-wave"></i>
                </div>
                <div class="text-2xl font-bold text-gray-800">{{ number_format($jumlaMadeni, 0) }} <span class="text-sm">Tsh</span></div>
                <div class="text-sm text-gray-600 mt-1">Jumla ya Madeni</div>
            </div>
            
            <div class="text-center p-5 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200">
                <div class="inline-flex p-3 rounded-xl bg-amber-100 text-amber-600 mb-3">
                    <i class="fas fa-users"></i>
                </div>
                <div class="text-2xl font-bold text-gray-800">{{ number_format($idadiMadeni) }}</div>
                <div class="text-sm text-gray-600 mt-1">Idadi ya Madeni</div>
            </div>
        </div>
    </div>
</div>
...
<!-- Performance Summary -->
<div class="bg-gradient-to-r from-amber-500 to-amber-600 rounded-2xl p-6 shadow-xl text-white">
    <div class="flex flex-col md:flex-row items-center justify-between">
        <div class="flex items-center mb-4 md:mb-0">
            <div class="p-4 rounded-2xl bg-blue/40 mr-4">
                <i class="fas fa-chart-pie text-2xl"></i>
            </div>
            <div>
                <h3 class="text-xl text-black font-bold mb-1">Muhtasari wa Utendaji</h3>
                <p class="text-black">
                    @if($faidaHalisiLeo > 0)
        ...
        <div class="text-right">
            <div class="text-sm text-black">Hali ya Sasa</div>
            <div class="text-2xl font-bold">
                @if($faidaHalisiLeo > 0)
                    <span class="text-white">Imefanikiwa</span>
                @else
                    <span class="black-300">Inahitaji Mkaguzi</span>
                @endif
            </div>
        </div>
    </div>
