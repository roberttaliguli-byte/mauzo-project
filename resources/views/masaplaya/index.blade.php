...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 card-hover">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm text-gray-500 font-medium">Wenye Simu</p>
                    <h3 class="text-2xl font-bold text-gray-800">{{ $masaplaya->whereNotNull('simu')->count() }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 card-hover">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm text-gray-500 font-medium">Wenye Email</p>
                    <h3 class="text-2xl font-bold text-gray-800">{{ $masaplaya->whereNotNull('barua_pepe')->count() }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 card-hover">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm text-gray-500 font-medium">Wenye Ofisi</p>
                    <h3 class="text-2xl font-bold text-gray-800">{{ $masaplaya->whereNotNull('ofisi')->count() }}</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Success Message -->
    @if(session('success'))
        <div class="bg-green-100 border border-green-200 text-green-800 p-4 rounded-lg flex items-center">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 card-hover">
        <div class="flex space-x-6 border-b border-gray-200">
            ...
            >
                <i class="fas fa-plus-circle mr-2"></i>Sajili Msaplaya Mpya
            </button>
        </div>
    </div>
                ...
                <table class="w-full table-auto">
                    <thead>
                        <tr class="bg-gradient-to-r from-green-600 to-green-700">
                            <th class="px-6 py-4 text-left text-sm font-semibold text-white">Msaplaya</th>
    ...
    <div id="content-sajili" class="tab-content bg-white rounded-2xl shadow-lg border border-gray-100 p-6 card-hover" style="display: none;">
...
<!-- Details Modal -->
<div id="detailsModal" class="hidden fixed inset-0 z-50 flex items-center justify-center modal-overlay">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl mx-4" onclick="event.stopPropagation()">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">Taarifa Kamili za Msaplaya</h3>
        </div>
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-3">
                    <div>
                        <label class="text-sm font-medium text-gray-500">Jina la Msaplaya:</label>
                        <p id="detail_jina" class="text-gray-900 font-semibold"></p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500">Simu:</label>
                        <p id="detail_simu" class="text-gray-900"></p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500">Barua Pepe:</label>
                        <p id="detail_barua_pepe" class="text-gray-900"></p>
                    </div>
                </div>
                <div class="space-y-3">
                    <div>
                        <label class="text-sm font-medium text-gray-500">Ofisi:</label>
                        <p id="detail_ofisi" class="text-gray-900"></p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500">Makazi:</label>
                        <p id="detail_anaopoishi" class="text-gray-900"></p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-500">Maelezo:</label>
                        <p id="detail_maelezo" class="text-gray-900"></p>
                    </div>
                </div>
            </div>
